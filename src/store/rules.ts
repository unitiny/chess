...
interface Rules {
    (chesses: Array<Chess>, start: Array<number>,
     target: Array<number>, bottom: number, action?: string)
}
...
let ruleFunc: RuleFunc = {}

function init() {
    ruleFunc[CHESS_NAME.SOLDIER] = Soldier
    ruleFunc[CHESS_NAME.CANNON] = Cannon
    ruleFunc[CHESS_NAME.CAR] = Car
    ruleFunc[CHESS_NAME.HORSE] = Horse
    ruleFunc[CHESS_NAME.ELEPHANT] = Elephant
    ruleFunc[CHESS_NAME.SCHOLAR] = Scholar
    ruleFunc[CHESS_NAME.KING] = King
}
 ...
 * @param action
 */
function Soldier(chesses: Array<Chess>, start: Array<number>, target: Array<number>, bottom: number, action: string) {
 ...
 * @param action
 */
function Horse(chesses: Array<Chess>, start: Array<number>, target: Array<number>, bottom: number, action: string) {
 ...
 * @param action
 */
function Elephant(chesses: Array<Chess>, start: Array<number>, target: Array<number>, bottom: number, action: string) {
 ...
 * @param action
 */
function Scholar(chesses: Array<Chess>, start: Array<number>, target: Array<number>, bottom: number, action: string) {
    let startOffset = Math.abs(start[1] - bottom)
    let targetOffset = Math.abs(target[1] - bottom)
 ...
 * @param action
 */
function King(chesses: Array<Chess>, start: Array<number>, target: Array<number>, bottom: number, action: string) {
